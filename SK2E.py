...
class SK2E:
   ...
   def Ex_x2y2(self,l,m,n,SKparam):
      return ( sqrt(3)/2 * l * (l**2-m**2) * SKparam["pd_sigma"]
                   + l * (1 - l**2 + m**2) * SKparam["pd_pi"])
                         
   def Ex_3z2r2(self,l,m,n,SKparam):
      return ( l * (n**2 - 0.5*(l**2+m**2)) * SKparam["pd_sigma"]
   ...
   def Ey_x2y2(self,l,m,n,SKparam):
      return ( sqrt(3)/2 * m * (l**2-m**2) * SKparam["pd_sigma"]
                   - m * (1 + l**2 - m**2) * SKparam["pd_pi"])
                   
   def Ey_3z2r2(self,l,m,n,SKparam):
      return ( m * (n**2-0.5*(l**2+m**2)) * SKparam["pd_sigma"]
   ...
   def Exy_x2y2(self,l,m,n,SKparam):
      return ( 1.5 * l*m * (l**2-m**2) * SKparam["dd_sigma"]
              +  2 * l*m * (m**2-l**2) * SKparam["dd_pi"]
              +0.5 * l*m * (l**2-m**2) * SKparam["dd_delta"])

   def Exy_3z2r2(self,l,m,n,SKparam):
      return (sqrt(3) * l*m *(n**2 - 0.5*(l**2+m**2)) * SKparam["dd_sigma"]
              - 2*sqrt(3) * l*m *    n**2  * SKparam["dd_pi"]
              + sqrt(3)/2 * l*m * (1+n**2) * SKparam["dd_delta"])
   ...
   def Exz_x2y2(self,l,m,n,SKparam):
      return ( 1.5 *  n*l *(l**2-m**2)  * SKparam["dd_sigma"]
             + n*l *  (1-2*(l**2-m**2)) * SKparam["dd_pi"]
             - n*l *(1-0.5*(l**2-m**2)) * SKparam["dd_delta"])

   def Exz_3z2r2(self,l,m,n,SKparam):
      return ( sqrt(3) * l*n * (n**2 - 0.5*(l**2+m**2)) * SKparam["dd_sigma"]
             + sqrt(3) * l*n * (l**2 + m**2 - n**2)     * SKparam["dd_pi"]
             - sqrt(3)/2*l*n * (l**2 + m**2)            * SKparam["dd_delta"])
   ...
   def Ex2y2_3z2r2(self,l,m,n,SKparam):
      return ( sqrt(3)/2 * (l**2-m**2) * (n**2-(l**2+m**2)/2) * SKparam["dd_sigma"]
                     + sqrt(3) *      n**2  *  (m**2-l**2)    * SKparam["dd_pi"]
		            + sqrt(3)/4  * (1 + n**2) *  (l**2-m**2)    * SKparam["dd_delta"])
   ...
   def E3z2r2_3z2r2(self,l,m,n,SKparam):
      return ( (n**2 - 0.5 * (l**2+m**2))**2 * SKparam["dd_sigma"]
