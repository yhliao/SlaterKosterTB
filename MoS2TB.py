...
H04.fill_SK("S_u","S_u",[1./2,-sqrt(3)/2,0],SS)
H04.fill_SK("S_d","S_d",[1./2,-sqrt(3)/2,0],SS)
H04.fill_SK("Mo","S_u",[0.4483428791,-0.7765526458, 0.4426676528],MoS)
H04.fill_SK("Mo","S_d",[0.4483428791,-0.7765526458,-0.4426676528],MoS)
'''
...
H06.fill_SK("S_u","S_u",[1./2,sqrt(3)/2,0],SS)
H06.fill_SK("S_d","S_d",[1./2,sqrt(3)/2,0],SS)
H06.fill_SK("S_d","Mo",[0.4483428791,0.7765526458, 0.4426676528],SMo)
H06.fill_SK("S_u","Mo",[0.4483428791,0.7765526458,-0.4426676528],SMo)
'''
